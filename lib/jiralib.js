...
const loadEasierStoriesInQANow = async (config) => {
    let query = format('issuetype = "Easier Story" and status = "In Easier QA"', config);
    return new Promise((resolve, reject) => {
        let relatedStories = [];
        let relatedDefects = [];
        let result = [];
...
module.exports = {
  init, loadEasierTests, loadEasierStoriesMovedFromQAtoValidation, loadIssue, loadIssues, loadEasierStoriesInQANow
};